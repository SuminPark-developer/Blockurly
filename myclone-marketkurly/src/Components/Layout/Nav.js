          ...
          >
            ...
            <div>
              <ul>
                ...
                >
                  <span id="prof-grade">생산자</span>
                  <span style={{ color: "#5f0080" }}>황보현님</span>
                  <ul
          ...
          <div className={headerFixed ? "nav-bottom fixed" : "nav-bottom"}>
            ...
            <ul className="nav-bottom-bar">
              ...
              <li className="nav-bottom-bar-item">
                <a href="http://localhost:3000/"><span>신상품</span></a>
              </li>
              <li className="nav-bottom-bar-item">
                <a href="http://localhost:3000/"><span>베스트</span></a>
              </li>
              <li className="nav-bottom-bar-item">
                <a href="http://localhost:3002/"><span>토큰으로 구입하기</span></a>
              </li>
              <li className="nav-bottom-bar-item">
                <a href="http://localhost:3001/todolist/chain"><span>유통 과정</span></a>
              </li>
